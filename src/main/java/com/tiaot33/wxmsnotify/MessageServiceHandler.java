...
public class MessageServiceHandler {
    ...
    public static final String OY = "push-bot";
    ...
    public void sendFileMsg() {
        ...
        msgFile.setMediaId("3CdT6EOwj1ONZwfxQTzIMTowZQvVTBrYU08dzu9d_ZCI1eXA3QjQTXOigq55Qdc0j");
    ...
    private SendMessageRequest buildSendMessageRequest() {
        ...
        request.setAgentId("1000002");
        request.setToUser("@all");
        return request;
    }
}
